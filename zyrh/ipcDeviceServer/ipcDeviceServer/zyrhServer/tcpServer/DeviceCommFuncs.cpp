...
unsigned char cmd113406[]={
0x00,0x00,0x03,0xcc,0x00,0x02,0x00,0x02,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,
0x03,0xb8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x32,0x02,0x00,0x32,0x00,0x00,
...
unsigned char cmd113402[]={
,
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x32,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
unsigned char cmd113400[]={
0x00,0x00,0x05,0x74,0x00,0x01,0xff,0xde,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,
0x05,0x60,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
 ...
 ***********************************************************************/
STATUS sendNetRetval(StreamSocket  &connfd, UINT32 retVal)
{
...
STATUS netClientGetRtspPort(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr,void *param)
{
	...
	if(retVal == NETRET_QUALIFIED)
	{
		...
		netCmdRtspCfg.rtspCfg.length = htonl(sizeof(NETPARAM_RTSP_CFG));
		netCmdRtspCfg.rtspCfg.rtspPort = htons(ptrIpcDeviceParams->m_rtspServerPort);
        NET_INFO(("GET RTSP PORT %d\n",ptrIpcDeviceParams->m_rtspServerPort));
	}
...
STATUS netClientReloveCmd1134(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr,UINT32 cmdType)
{
	...
	{
	case 0x113406:		
		NET_INFO(("NETCMD_0x113406.\n"));
		retVal=connfd.sendBytes((char *)cmd113406, sizeof(cmd113406),0);
		break;
	case 0x113402:
		NET_INFO(("NETCMD_0x113402.\n"));
		retVal=connfd.sendBytes((char *)cmd113402, sizeof(cmd113402),0);
		break;
	case 0x113400:
		NET_INFO(("NETCMD_0x113400.\n"));
		retVal=connfd.sendBytes((char *)cmd113400, sizeof(cmd113400),0);
		break;
	default:
			retVal=-2;
			break;
...
STATUS netClientReloveCmd11000(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr)
{
	...
	switch(cmd0)
	{
		case 0x1:
			...
			memcpy(cmd11000_01,&header,sizeof(header));
			retVal=connfd.sendBytes((char *)cmd11000_01,sendlen,0);
			break;
		case 0x5:
			...
			memcpy(cmd11000_05,&header,sizeof(header));
			retVal=connfd.sendBytes((char *)cmd11000_05,sendlen,0);
			break;
		case 0x8:
			...
			memcpy(cmd11000_08,&header,sizeof(header));
			retVal=connfd.sendBytes((char *)cmd11000_08,sendlen,0);
			break;
		case 0xe:
			...
			header.checkSum = htonl(checkByteSum((char *)cmd11000_0E+8, sendlen - 8));
			memcpy(cmd11000_0E,&header,sizeof(header));
			retVal=connfd.sendBytes((char *)cmd11000_0E,sendlen,0);
			break;
		case 0x11:
			bzero((char *)&header, sendlen);
			...
			if(cmd1==0X3C50545A)
			{
				...
				memcpy(cmd11000_11_3C50545A,&header,sizeof(header));
				retVal=connfd.sendBytes((char *)cmd11000_11_3C50545A,sendlen,0);
			}
			else if(cmd1==0X3C457665)
			{
				...
				memcpy(cmd11000_11_3C457665,&header,sizeof(header));
				retVal=connfd.sendBytes((char *)cmd11000_11_3C457665,sendlen,0);
			}
			else
				retVal=-1;
			break;
...
STATUS netClientGetPicCfgV30(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr)
{
	...
	{
		0x00,0x00,0x07,0xc0,0x00,0x00,0x4f,0x67,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,
		0x00,0x00,0x07,0xb0,0x43,0x61,0x6d,0x65,0x72,0x61,0x20,0x30,0x31,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		...
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0xff,0x01,0x00,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,
		...
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x20,
		0x01,0x01,0x04,0x00,0xff,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
STATUS netClientPTZControl(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr,NET_PTZ_CTRL_DATA &netPTZCtrlData)
{
	...
	UINT32 position=1, speed=0, cruNum=1, ListNum=1, dwellTime=0;

	memcpy((char *)&netPTZCtrlData, recvbuff, sizeof(netPTZCtrlData));
	chan = ntohl(netPTZCtrlData.channel);
	//chan = getMatchChan(chan);
	netPTZCtrlData.command = ntohl(netPTZCtrlData.command);
	netPTZCtrlData.presetNo = ntohl(netPTZCtrlData.presetNo);

	printf("netPTZCtrlData.command %d netPTZCtrlData.presetNo %d\n",netPTZCtrlData.command,netPTZCtrlData.presetNo);
	return sendNetRetval(connfd, 1);
...
STATUS netClientPTZControlWithSpeed(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr,NET_PTZ_CTRL_DATA &netPTZCtrlData)
{
	...
	char devName[32];
	UINT64 netPtzCtrlPermission;
	UINT32 position=0, speed=0, cruNum=0, ListNum=0, dwellTime=0;
	memcpy((char *)&netPTZCtrlData, recvbuff, sizeof(netPTZCtrlData));
	//chan = ntohl(netPTZCtrlData.channel);
	netPTZCtrlData.command = ntohl(netPTZCtrlData.command);
...
STATUS netClientGetOSDCfgV30(StreamSocket  &connfd, char *recvbuff, struct sockaddr_in *pClientSockAddr)
{
	...
	struct{
		NETRET_HEADER header;
		NETPARAM_NETOSD_CFG_V30 netOSDCfg;
	}netRetOSDCfg;
	UINT32 retVal=NETRET_QUALIFIED;
	char tempString[]=
	{
		0x00,0x00,0x01,0xb4,0x00,0x00,0x03,0x66,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0xa4,
	...
	memset((char *)&netRetOSDCfg,0,sendlen);
	netRetOSDCfg.header.length=htonl(sendlen);
	netRetOSDCfg.header.retVal = htonl(retVal);
	netRetOSDCfg.netOSDCfg.length=htonl(sizeof(NETPARAM_NETOSD_CFG_V30));
	netRetOSDCfg.header.checkSum = htonl(checkByteSum((char *)&(netRetOSDCfg.header.retVal), sendlen-8));
